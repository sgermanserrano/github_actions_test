^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package demo_nodes_cpp2
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
0.7.3 (2019-05-10)
------------------
* Added the ``parameter_blackboard`` demo to ``demo_nodes_cpp2`` to make some tutorials easier. (`#333 <https://github.com/ros2/demos/issues/333>`_)
* Contributors: William Woodall
...
* Refined demo_nodes_cpp2 source codes (`#269 <https://github.com/ros2/demos/issues/269>`_)
...
* Fixed a potiential nullptr dereference issue in ``demo_nodes_cpp2``. (`#242 <https://github.com/ros2/demos/issues/242>`_)
