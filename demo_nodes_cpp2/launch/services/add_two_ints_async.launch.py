demo_nodes_cpp2# Copyright 2018 Open Source Robotics Foundation, Inc.
#
...
def generate_launch_description():
    server = launch_ros.actions.Node(
        package='demo_nodes_cpp2', node_executable='add_two_ints_server', output='screen')
    client = launch_ros.actions.Node(
        package='demo_nodes_cpp2', node_executable='add_two_ints_client_async', output='screen')
